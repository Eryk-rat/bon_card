                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            @if (Auth::check())
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Strona Z Viu.js</h2>
                                </a>
                            ...
                            @if (Auth::check())
                                ...
                                <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                    width="764.000000pt" height="564.000000pt" viewBox="0 0 764.000000 564.000000"
                                    preserveAspectRatio="xMidYMid meet">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Strona bez Viu.js </h2>
